...
countryList.forEach(function (country) {
    var term = country.toUpperCase();
    var terms = [];
    for (var i = 0; i < term.length; i++) {
        terms.push({ score: 0, member: term.substring(0, i) });
    }
    terms.push({ score: 0, member: term + '*' });
    var popuateDb = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                //@ts-expect-error
                return [4 /*yield*/, redis.zadd.apply(redis, __spreadArray(['terms'], terms, false))];
                case 1:
                    //@ts-expect-error
                    _a.sent();
                    return [2 /*return*/];
